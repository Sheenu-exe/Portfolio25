    ...
    return (
      <>
        ...
        <motion.div
          ...
          {...props}
          className={cn(
            "hidden md:supports-backdrop-blur:bg-white/10 md:supports-backdrop-blur:dark:bg-black/10 md:mx-auto md:mt-8 md:flex md:h-[58px] md:w-max md:gap-2 md:rounded-2xl md:border md:border-white/40 md:p-2 md:backdrop-blur-md",
            className,
            {
